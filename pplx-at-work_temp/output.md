...
[Comet](https://www.perplexity.ai/comet)                 [Labs](https://www.perplexity.ai/labs)
![](images/000118.png)
...
研究                  [Spaces](https://www.perplexity.ai/spaces)
![](images/000121.png)
...
[Email Assistant](https://www.perplexity.ai/assistant)            Perplexity无需在账户和应用之间切换，让所有工作保持连接
...
[Comet](https://www.perplexity.ai/comet) 为您提供两种助手：侧边栏助手和代理。

助手是您理解、阅读和回答问题的首选。这就像在浏览器中有一个聪明的朋友，能解释事情并帮助您做出好的决定。
...
[使用 Perplexity 应用连接器](https://www.perplexity.ai/account/connectors)可在所有连接的平台进行统一搜索。

提示："找到 Notion 中产品路线图演示的最新版本以及上周利益相关者审查的任何反馈。"
...
→ [Comet 快捷方式](https://www.perplexity.ai/account/shortcuts)是可在 Comet 中执行的简单命令——只需在浏览器中输入 "/" 并说出需要发生的事情。无论是多步骤流程还是每周都会做的事情，你都可以设置一次，然后让 Comet 点击处理。

→ [Perplexity 任务](https://www.perplexity.ai/account/tasks?tab=scheduled)适用于你想定期提出的研究查询。也许你每天需要一份邮件报告、仪表板更新或新闻扫描——只需设置任务，它就会按计划运行，无需再费心。
...
1. 搜索内部资源，如常见问题解答、帮助中心文章、销售演示、培训文档、产品简介和营销指南。
...
3. 如果存在多个版本或套餐，请说明各层级的可用内容。

4. 在适当时，建议如何针对不同受众组织答案（例如：买家 vs. 用户）。

5. 如有来源，请务必引用或链接到原始材料。

语气：清晰、自信、乐于助人——帮助用户在任何销售或营销对话中表现出色。

如果内容无法涵盖答案，请告知用户缺失的信息，并建议可能提供帮助的团队或文档。

访问我们的[模板库](https://www.perplexity.ai/spaces/templates)获取更多 Perplexity Space 模板
...
- 获胜原因细分（例如价格、产品契合度、关系、品牌、时机）
- 输单原因细分，使用相同类别

- 随时间变化的趋势（每月或每季度），以识别胜/输驱动因素的变化
- 按地区、行业、交易规模和销售人员筛选

- 可视化图表，如柱状图、漏斗图和热力图，使模式清晰
- 关键要点或见解，总结影响结果的主要驱动因素
