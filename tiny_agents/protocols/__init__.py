...
简洁导入示例：
    >>> from tiny_agents.protocols import MCPClient, MCPServer
...
完整导入示例（向后兼容）：
    >>> from tiny_agents.protocols.mcp import MCPClient, MCPServer
    >>> from tiny_agents.protocols.a2a import A2AServer, A2AClient
    >>> from tiny_agents.protocols.anp import ANPDiscovery, ANPNetwork
"""
