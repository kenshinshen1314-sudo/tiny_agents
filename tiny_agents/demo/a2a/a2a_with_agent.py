...
from tiny_agents.tools import ToolRegistry, Tool, ToolParameter
import threading
import time
...
tech_expert = A2AServer(
    name="tech_expert",
    description="你是一位技术功底深厚且热心的技术专家，擅长并且会热心地回答技术相关问题",
    version="1.0.0"
)
...
sales_advisor = A2AServer(
    name="sales_advisor",
    description="你是一位专业的销售顾问，擅长回答销售相关问题，并且会耐心地解释销售策略",
    version="1.0.0"
)
...
receptionist = SimpleAgent(
    name="接待员",
    llm=llm,
    system_prompt="""你是一位专业的客服接待员，具备认真、礼貌、专业、有耐心等品质。你主要负责的工作如下：
