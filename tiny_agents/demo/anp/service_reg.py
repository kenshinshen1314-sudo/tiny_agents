from tiny_agents.protocols import ANPDiscovery, register_service
...
from tiny_agents.protocols import discover_service
...
from tiny_agents.protocols import ANPNetwork

# 创建网络
network = ANPNetwork(network_id="anp_network_cluster")
