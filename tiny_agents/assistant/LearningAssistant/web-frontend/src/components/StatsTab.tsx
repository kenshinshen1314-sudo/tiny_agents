  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {statsItems.length > 0 ? (
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-12 text-center animate-in fade-in duration-500">
      ...
      {/* 当前文档状态 */}
      {loadedDocument && (
        <div className="bg-gradient-to-r from-slate-900/50 to-slate-900/50 backdrop-blur-sm rounded-2xl border border-cyan-500/30 p-5 flex items-center gap-4 animate-in fade-in slide-in-from-left-4 duration-500">
