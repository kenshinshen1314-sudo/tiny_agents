...
class NPCBatchGenerator:
    ...
    def __init__(self):
        ...
        self.preset_dialogues = {
            ...
            "noon": {
                "Bob": "写了一上午代码,终于把那个bug修复了!",
                "Alice": "上午的需求评审会很顺利,下午继续推进。",
                "Lily": "这个配色方案看起来不错,再调整一下细节。",
                "Sam": "上午搭建好了基础架构，下午继续写代码,这个算法还需要优化一下。",
                "Kenshin": "上午终于搞懂y这个模型的原理了,下午继续跑实验,看一下结果。"

            },
            "afternoon": {
                "Bob": "下午继续写代码,这个算法还需要优化一下。",
                "Alice": "正在准备下周的产品规划会,需求文档快完成了。",
                "Lily": "设计稿基本完成了,等会儿发给大家看看。",
                "Sam": "下午继续写代码,这个算法还需要优化一下。",
                "Kenshin": "下午继续跑实验,看一下结果。顺便再看看其他算法"
            },
            "evening": {
                "Bob": "今天的代码提交完成,明天继续!",
                "Alice": "今天的工作差不多了,整理一下明天的待办事项。",
                "Lily": "设计工作告一段落,明天再继续优化。",
                "Sam": "晚上继续写代码,这个算法还需要优化一下。",
                "Kenshin": "晚上继续跑实验,看一下结果。顺便再刷刷最近的AI论文。"
            }
        }
