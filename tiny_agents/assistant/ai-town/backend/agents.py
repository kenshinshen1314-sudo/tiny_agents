...
from tiny_agents.memory import MemoryManager, MemoryConfig, MemoryItem
...
NPC_ROLES = {
    "Bob": {
        ...
        "expertise": "多智能体系统、TinyAgents框架、Python开发、代码优化",
    ...
    "Sam": {
        ...
        "activity": "设计架构",
        "personality": "技术宅,喜欢讨论算法和框架",
        "expertise": "多智能体系统、TinyAgents框架、架构设计、系统优化",
        "style": "优雅简洁,喜欢用艺术化的表达,追求完美",
        "hobbies": "研究新框架、参与项目合作、分享知识"
    },
    "Kenshin": {
        "title": "AI算法工程师",
        "location": "工位区",
        "activity": "写代码",
        "personality": "技术宅,喜欢讨论AI算法和框架",
        "expertise": "多智能体系统、TinyAgents框架、Python开发、算法优化",
        "style": "简洁专业,喜欢用技术术语,偶尔吐槽bug",
        "hobbies": "看AI论文、研究新算法、分享知识"
    }
}
...
"""
    ...
    def _save_conversation_to_memory(
        ...
        memory_manager.add_memory(
            ...
            auto_classify=False,  # 禁用自动分类，使用指定的 memory_type
            metadata={
                "speaker": "player",
                "player_id": player_id,
