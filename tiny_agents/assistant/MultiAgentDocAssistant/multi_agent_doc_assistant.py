...
# 加载.env文件中的环境变量
load_dotenv(dotenv_path="../tiny_agents/.env")
...
# Agent 1: GitHub搜索专家
# ============================================================
print("\n【步骤1】创建: GitHub仓库搜索Agent...")

github_searcher = SimpleAgent(
    name="GitHub仓库搜索Agent",
    llm=HelloAgentsLLM(),
    system_prompt="""你是一个专业的GitHub仓库搜索Agent。
...
try:
    # 步骤1：GitHub搜索
    print("\n【步骤3】GitHub仓库搜索Agent 执行: 搜索GitHub仓库...")
