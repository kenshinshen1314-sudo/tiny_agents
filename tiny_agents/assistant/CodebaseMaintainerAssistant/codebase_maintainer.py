...
from tiny_agents.context import ContextBuilder, ContextConfig, ContextPacket
from tiny_agents.tools import MemoryTool, NoteTool, TerminalTool
...
def main():
    ...
    maintainer = CodebaseMaintainer(
        project_name="tiny_agents",
        codebase_path="../tiny_agents",
        llm=HelloAgentsLLM()
    )
