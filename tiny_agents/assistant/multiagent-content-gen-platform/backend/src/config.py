...
class Configuration(BaseModel):
    ...
    # Content generation specific config
    content_llm_timeout: int = Field(
        default=180,
        title="Content LLM Timeout",
        description="Timeout in seconds for content generation LLM calls",
    )
    content_max_tokens: int = Field(
        default=4000,
        title="Content Max Tokens",
        description="Maximum tokens for content generation output",
    )
